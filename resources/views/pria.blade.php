        ...
        <div class="col-md-4 col-sm-12 mb-5">
          <div class="card">
            ...
            <div class="card-img-overlay text-uppercase text-white font-weight-bolder mt-5">
              ...
              <p class="card-text">A very comfortable outfit to wear on weekdays or weekdays</p>
              <a href="celanawanita"><button type="button" class="btn btn-outline-light me-2">Shop</button></a>
            </div>
          </div>
        </div>
        <div class="col-md-4 col-sm-12 mb-5">
          <div class="card">
            ...
            <div class="card-img-overlay text-uppercase text-white font-weight-bolder mt-5">
              ...
              <p class="card-text">A very comfortable outfit to wear on weekdays or weekdays</p>
              <a href="sepatuwanita"><button type="button" class="btn btn-outline-light me-2">Shop</button></a>
            </div>
          </div>
          </div>
        </div>
